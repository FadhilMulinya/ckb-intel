...
from . import capacity, scripts, temporal, templates, topology
...
def assess_observation(observation: dict) -> dict:
    ...
    script_result = scripts.extract(observation)
    capacity_result = capacity.extract(observation)
    ...
    return {"features": {"temporal": temporal_result.as_dict(),
                         ...
                         "scripts": script_result.as_dict(),
                         "capacity": capacity_result.as_dict()},
